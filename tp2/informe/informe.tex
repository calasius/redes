...
y luego arroja para diferentes TTLs los tiempos de RTT y geolocalización de la dirección IP.
Se van a enviar paquetes con diferentes TTL y ver cómo se comporta los tiempos y analizar las respuestas recibidas por nuestra herramienta
\end{abstract}
...
\input{metodos_y_condiciones.tex}
\input{resultados.tex}
\input{analisis_global.tex}
